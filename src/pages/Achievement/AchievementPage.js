...
function AchievementPage() {
    ...
    const filteredArticles = achievementData.achievements.filter((achievement) => {
        const content = achievement.title + achievement.details + achievement.field
